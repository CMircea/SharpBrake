...
namespace System
{
    ...
    public static class Extensions
    {
        ...
        {
            exception.SendToAirbrake(new AirbrakeConfiguration());
        }
        ...
        /// 
        /// <param name="exception">The exception to send to Airbrake.</param>
        /// <param name="configuration">The Airbrake client configuration.</param>
        public static void SendToAirbrake(this Exception exception, AirbrakeConfiguration configuration)
        {
            var client = new AirbrakeClient(configuration);
